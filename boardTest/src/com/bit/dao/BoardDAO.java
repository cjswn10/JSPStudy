...
public class BoardDAO {
	...
	public ArrayList<BoardVO> listBoard(int pageNUM) {
		...
		String sql = "SELECT no, title, writer, pwd, regdate, hit, content, fname, fsize, ip " + 
				"FROM " + 
				"(SELECT rownum r, no, title, writer, pwd, regdate, hit, content, fname, fsize, ip " + 
				"FROM " + 
				"(SELECT * FROM board ORDER BY regdate desc)) a " + 
